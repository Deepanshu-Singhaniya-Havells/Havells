                    ...
                    foreach (Entity tendPrd in tendPrdColl.Entities)
                    {
                        try
                        {
                            ...
                            if (tendPrd.Contains("hil_product"))
                            {
                                ...
                                if (entColPrdLstAmt.Entities[0].Contains("hil_cogs"))
                                    tendPrd["hil_cogs"] = new Money(entColPrdLstAmt.Entities[0].GetAttributeValue<Money>("hil_cogs").Value);
                            ...
                            {
                                tracingService.Trace("Product Dosn't Contains");
                            }
                        }
                        catch
                        {
