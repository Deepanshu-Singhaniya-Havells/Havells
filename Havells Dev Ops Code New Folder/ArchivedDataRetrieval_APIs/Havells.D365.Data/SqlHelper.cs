...
namespace Havells.D365.Data
{
    ...
    public sealed class SqlHelper
    {
        ...
        public static DataSet ExecuteProc(string connectionString, String CommText, SqlParameter[] SqlParam)
        {
            SqlDataAdapter da;
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                if (con.State == ConnectionState.Closed)
                    con.Open();
                using (SqlCommand cmd = new SqlCommand(CommText, con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddRange(SqlParam);
                    cmd.CommandTimeout = 0;   // add by nanhe
