...
namespace EMS_OA_SAPIntegration
{
    public class Program
    {
        ...
        public static void sendEmail(IOrganizationService _service, string mailbody, EntityReference ordercheklistid, EntityReference owner, string status, string orderchecklistno, string CustomerName, string ProjectName)
        {
            ...
            //entFrom["partyid"] = new EntityReference("queue", new Guid("a81ac51b-c9df-eb11-bacb-0022486ea537")); // EMS
            entFrom["partyid"] = new EntityReference("queue", new Guid("48D8CA75-6D32-EC11-B6E6-002248D4CE49")); // OMS
