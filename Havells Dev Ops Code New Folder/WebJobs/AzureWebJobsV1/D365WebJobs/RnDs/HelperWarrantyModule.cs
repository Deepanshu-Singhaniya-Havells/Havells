    ...
    public class HelperWarrantyModule
    {
        public static void Init_Warranty(Guid entityId, IOrganizationService _service)
        {
            try
            {
                ...
                qryExp.ColumnSet = new ColumnSet("hil_invoiceavailable", "hil_productcategory", "hil_invoicedate", "hil_productsubcategory", "msdyn_product", "hil_modelname", "hil_customer");
