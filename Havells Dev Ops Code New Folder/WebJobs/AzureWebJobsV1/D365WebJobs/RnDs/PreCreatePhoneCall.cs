...
namespace HavellsNewPlugin.PhoneCall
{
    public class PreCreatePhoneCall : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity && context.PrimaryEntityName.ToLower() == "phonecall" && context.MessageName.ToUpper() == "CREATE" && context.Depth==1)
                {
            ...
            {
                throw new InvalidPluginExecutionException("Deepanshu_Plugin.Appointment.PreCreate.Execute: " + ex.Message);
            }
            #endregion
        }
