...
namespace D365WebJobs
{
    ...
    public class CreateEnquiry
    {
        ...
        public ReturnInfoVar CreateEnquiryEntry(CreateEnquiry obj_Enquiry, IOrganizationService service)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    obj_createEnquiryRecord.Attributes["description"] = obj_Enquiry.Remarks +  " Selected Division Codes: " + productDivisionID;
        ...
        public List<EnquiryType> GetEnquiryTypes(EnquiryType _enquiryCategory, IOrganizationService service)
        {
        ...
        public List<EnquiryProductType> GetEnquiryProductTypes(EnquiryProductType _enquiryCategory, IOrganizationService service)
        {
