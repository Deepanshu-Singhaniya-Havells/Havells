...
namespace TestApp
{
    public class D365AuditLog
    {
        ...
        public List<D365AuditLogResult> GetD365AuditLogData(D365AuditLog _requestData, IOrganizationService service)
        {
        ...
        //static void D365AuditLogMigration(IOrganizationService _service,string _entityName, string _recId)
        //{
        //    int i = 1;
        ...
        //    //QueryExpression Query = new QueryExpression(entityLogicalName);
        //    //Query.ColumnSet = new ColumnSet(primaryKeySchemaName);
        //    ////Query.Criteria.AddCondition("createdon", ConditionOperator.OnOrAfter, "2020-01-01");
        //    ////Query.Criteria.AddCondition("createdon", ConditionOperator.OnOrBefore, "2020-01-31");
        //    ////Query.Criteria.AddCondition("hil_archivelog", ConditionOperator.NotEqual, true);
        //    //Query.Criteria.AddCondition("msdyn_name", ConditionOperator.Equal, "0110206558290");
        ...
        //                    if (strContent.ToString().Length > 0)
        //                    {
        //                        UploadAzureBlob(_recId.ToString(), strContent.ToString(), container);
