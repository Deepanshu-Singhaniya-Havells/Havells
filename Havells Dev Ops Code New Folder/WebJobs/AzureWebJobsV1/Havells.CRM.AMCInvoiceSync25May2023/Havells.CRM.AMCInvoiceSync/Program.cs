    ...
    public class Program
    {
        ...
        static void PushAMCData_DEV()
        {
            ...
            try
            {
                ...
                Query.Criteria.AddCondition(new ConditionExpression("msdyn_timeclosed", ConditionOperator.OnOrAfter, new DateTime(2022, 2, 04))); //
        ...
        static void PushAMCData_OmniChannel()
        {
            ...
            try
            {
                ...
                Query.Criteria.AddCondition(new ConditionExpression("name", ConditionOperator.Equal, "INV-2023-001871")); //Invoice ID
                    ...
                    foreach (Entity ent in ec.Entities)
                    {
                        try
                        {
                            ...
                            if (prodCode != null)
                            {
                                ...
                                string _AMCStartDate = GetWarrantyStartDate(_service, ent.GetAttributeValue<EntityReference>("hil_customerasset").Id, ent.GetAttributeValue<DateTime>("msdyn_invoicedate"));// DateTime.Now;
