...
namespace Havells.CRM.WP_AMC_SalesSyncToSAP.Model
{
    ...
    public class AMCSAPINvoiceTableCreate
    {
        ...
        public EntityReference AMCPlan { get; set; }
    }
    public class AMCSAPINvoiceTableUpdate
    {
        public string CallID { get; set; }
        public string MobileNumber { get; set; }
        public string SerialNumber { get; set; }
        ...
        public DateTime WarrantyEndDate { get; set; }
        public EntityReference AMCPlan { get; set; }
        public string SAPBillDoc { get; set; }
        public DateTime SAPBillDate { get; set; }
        public int? invoiceStatus { get; set; }
        public string AMCPlanName { get; set; }
    }
    public enum AMCSAPStatus
    {
        Draft = 1,
        Posted = 2,
        Invoiced = 3,
