...
namespace Havells.CRM.DynamicsPOSyncToSAP
{
    ...
    public class AmcBillingDetails
    {
    ...
    public class AmcBillingDetailList
    {
        public string RETURN { get; set; }
        public List<AmcBillingDetails> LT_TABLE { get; set; }
    }
