...
namespace ConsumerAppServices
{
    ...
    public class ConsumerAppWS : IConsumerAppWS
    {
        ...
        public AuthenticateCustomer ConsumerAppAuthenticateCustomerDE(AuthenticateCustomer Validate)
        {
            return new AuthenticateCustomer().ValidateThisCustomerDE(Validate);
        }
        ...
        {
            //ReturnInfo _retInfo = new ReturnInfo();
            //_retInfo = enquiry.CreateEnquiryEntry(enquiry);
            //return _retInfo;
        ...
        #region WhatsApp For Service/IoT Platform Web APIs
        ...
        public IoTRegisteredProductsResult IoTRegisterProduct(IoTRegisteredProducts productData)
        {
            IoTRegisteredProductsResult retObj = new IoTRegisteredProductsResult();
            IoTRegisteredProducts CustAssetObj = new IoTRegisteredProducts();
            retObj = CustAssetObj.IoTRegisterProduct(productData);
            return retObj;
        }
        ...
        public List<ProductDTO> GetProducts(Guid productSubCategoryId)
        {
            List<ProductDTO> _retInfo = new List<ProductDTO>();
            IoTCommonLib _commonLib = new IoTCommonLib();
            _retInfo = _commonLib.GetProducts(productSubCategoryId);
            return _retInfo;
        }
        ...
        {
            D365AuditLog _retInfo = new D365AuditLog();
            return _retInfo.GetAttributeMetadata(_entityLogicalName);
        }
        #endregion
        ...
        public WOSchemesResult PatchSchemeCode(ClaimExtToMobile _reqParam)
        {
            return new ClaimExtToMobile().PatchSchemeCode(_reqParam);
        }
        #endregion
        ...
        public ValidateSerialNumberMRN GetResponseFromSAP(ValidateSerialNumberMRN iValidate)
        {
            ValidateSerialNumberMRN _retObj = new ValidateSerialNumberMRN();
            return _retObj.GetResponseFromSAP(iValidate);
        }
        ...
        public ValidateSerialNumber ValidateSerialNumProductDelink(ValidateSerialNumber iValidate)
        {
            return new ValidateSerialNumber().GetResponseFromSAPProdDelink(iValidate);
        }
