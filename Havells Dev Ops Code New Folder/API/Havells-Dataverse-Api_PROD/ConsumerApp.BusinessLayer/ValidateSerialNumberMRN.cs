...
{
    [DataContract]
    public class ValidateSerialNumberMRN
    {
        [DataMember]
            ...
            try
            {
                ...
                if (IfExisting == false)
                {
                    using (OrganizationServiceContext orgContext = new OrganizationServiceContext(service))
                    {
                        ...
                        DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(SerialNumberValidationMRN));
                        SerialNumberValidationMRN rootObject = (SerialNumberValidationMRN)ser.ReadObject(new MemoryStream(jsonData));
