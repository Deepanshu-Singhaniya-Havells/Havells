...
namespace ConsumerApp.BusinessLayer
{
    ...
    public class ValidateSerialNumberDEV
    {
        ...
        {
            IOrganizationService service = ConnectToCRM.GetOrgServiceQA();
            try
            {
                ...
                if (IfExisting == false)
                {
                    using (OrganizationServiceContext orgContext = new OrganizationServiceContext(service))
                    {
                        ...
                        //string hil_Url = "https://middlewareqa.havells.com:50001/RESTAdapter/Service/ProductDetails?IM_SERIAL_NO=";
                        string hil_Url = "https://hsappoqa.havells.com:50001/RESTAdapter/Service/ProductDetails?IM_SERIAL_NO=";
                        ...
                        if (rootObject.EX_PRD_DET != null)//valid
                        {
                            ...
                            foreach (var iobj1 in obj1)
                            {
                                ...
                                iValidate.DIVISION = rootObject.EX_PRD_DET.SPART;
                                iValidate.REGION = rootObject.EX_PRD_DET.REGIO;
                                iValidate.INV_NO = rootObject.EX_PRD_DET.VBELN;
                                iValidate.INV_DATE = rootObject.EX_PRD_DET.FKDAT;
                                iValidate.CUST_CODE = rootObject.EX_PRD_DET.KUNAG;
                                iValidate.CUST_NAME = rootObject.EX_PRD_DET.NAME1;
                                iValidate.WTY_STATUS = rootObject.EX_PRD_DET.WTY_STATUS;
