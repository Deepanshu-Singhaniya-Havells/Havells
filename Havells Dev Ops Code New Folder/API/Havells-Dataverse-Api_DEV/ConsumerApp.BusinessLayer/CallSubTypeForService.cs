...
{
    [DataContract]
    public class CallSubtypeMasterForService
    {
        [DataMember(IsRequired = false)]
        public string CallSubTypeName { get; set; }
        [DataMember(IsRequired = false)]
        public string CallSubTypeId { get; set; }
        public List<CallSubtypeMasterForService> GetAllCallSubTypeService()
        {
            ...
            Qry.Criteria.AddCondition(new ConditionExpression("hil_name", ConditionOperator.Equal, "AMC Call"));
            Qry.Criteria.AddCondition(new ConditionExpression("hil_name", ConditionOperator.Equal, "Water Leakage"));
            ...
            {
                obj.Add(
                new CallSubtypeMasterForService
                {
