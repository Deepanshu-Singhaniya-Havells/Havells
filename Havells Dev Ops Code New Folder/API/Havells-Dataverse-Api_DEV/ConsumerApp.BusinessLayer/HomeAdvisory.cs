...
using System.Text;
using static ConsumerApp.BusinessLayer.IDPProcess;
...
namespace ConsumerApp.BusinessLayer
{
    public class HomeAdvisory
    {
        ...
        public HopmeAdvisoryResult CreateAdvisory(HomeAdvisoryRequest reqParm)
        {
            ...
            try
            {
                ...
                if (service != null)
                {
                    ...
                    if (string.IsNullOrEmpty(reqParm.SourceofCreation))
                    {
                    ...
                    for (int i = 0; i < reqParm.advisoryenquryline.Count; i++)
                    {
                        ...
                        {
                            if (!string.IsNullOrEmpty(reqParm.advisoryenquryline[i].Attachments[j].FileString))
                            {
                                try
                                {
                                ...
                                {
                                    homeadvresults.statusCode = "204";
                                    homeadvresults.statusDiscription = "Invalid Base64String!!";
                                    return homeadvresults;
                                }
                                if (string.IsNullOrEmpty(reqParm.advisoryenquryline[i].Attachments[j].Subject) ||
                                    string.IsNullOrEmpty(reqParm.advisoryenquryline[i].Attachments[j].FileName) ||
                                   string.IsNullOrEmpty(reqParm.advisoryenquryline[i].Attachments[j].FileSize) ||
                                   string.IsNullOrEmpty(reqParm.advisoryenquryline[i].Attachments[j].DocumentType))
                                {
                                    homeadvresults.statusCode = "204";
                                    homeadvresults.statusDiscription = "If FileString have data then Subject, FileName, FileSize, DocumentType is mandatory.";
                                    return homeadvresults;
                                }
                            }
                        }
                    }
                    if (!string.IsNullOrEmpty(reqParm.Salutation))
                    {
                        reqParm.Salutation = "1";
                    }
                    if (!string.IsNullOrEmpty(reqParm.CustomerType))
                    {
                        ...
                        {
                            homeadvresults.statusCode = "204";
                            homeadvresults.statusDiscription = "Customer Type does not Exist";
                            return homeadvresults;
                        }
                        #endregion
                    }
                    if (!string.IsNullOrEmpty(reqParm.PropertyType))
                    {
                        ...
                        {
                            homeadvresults.statusCode = "204";
                            homeadvresults.statusDiscription = "Property Type does not Exist";
                            return homeadvresults;
                        }
                        #endregion
                    }
                    if (!string.IsNullOrEmpty(reqParm.ConsturctionType))
                    {
                        ...
                        {
                            homeadvresults.statusCode = "204";
                            homeadvresults.statusDiscription = "Construction Type does not Exist";
                            return homeadvresults;
                        }
                        #endregion
                    }
                    if (!string.IsNullOrEmpty(reqParm.city))
                    {
                        #region CityFetch
                    ...
                    if (!string.IsNullOrEmpty(reqParm.state))
                    {
                        #region StateFetch
                    ...
                    if (!string.IsNullOrEmpty(reqParm.pincode))
                    {
                        #region PincodeFetch
                    ...
                    if (!string.IsNullOrEmpty(reqParm.mobilenumber))
                    {
                        ...
                        else
                        {
                            ...
                            if (!string.IsNullOrEmpty(reqParm.CustomerName))
                            {
                            ...
                            if (!string.IsNullOrEmpty(reqParm.emailid))
                                entConsumer["emailaddress1"] = reqParm.emailid;
                            entConsumer["hil_consumersource"] = new OptionSetValue(int.Parse(reqParm.SourceofCreation));
                    ...
                    {
                        homeadvresults.statusCode = "204";
                        homeadvresults.statusDiscription = "Mobile Number is Mandatory";
                        return homeadvresults;
                    }
                    ...
                    if (!string.IsNullOrEmpty(reqParm.CustomerRemarks))
                    ...
                    if (reqParm.advisoryenquryline[0].EnquryTypecode != null)
                    {
                        ...
                        {
                            homeadvresults.statusCode = "204";
                            homeadvresults.statusDiscription = "Enquiry Type does not Exist";
                            return homeadvresults;
                        }
                        #endregion
                    }
                    ...
                    Guid homeadvisory = Guid.Empty;
                    try
                    {
                        homeadvisory = service.Create(_AdvisoryEnquiry);
                    }
                    catch (Exception ex)
                    {
                        homeadvresults.statusCode = "403";
                    ...
                    for (int i = 0; i < reqParm.advisoryenquryline.Count; i++)
                    {
                        ...
                        if (reqParm.advisoryenquryline[i].ProductType != null)
                        {
                            ...
                            {
                                homeadvresults.statusCode = "204";
                                homeadvresults.statusDiscription = "Product Type does not Exist.";
                                return homeadvresults;
                            }
                            #endregion
                        }
                        if (!string.IsNullOrEmpty(reqParm.advisoryenquryline[i].Enqurystatus))
                        {
                        ...
                        if (!string.IsNullOrEmpty(reqParm.advisoryenquryline[0].ApointmentType))
                        ...
                        Guid _lineID = Guid.Empty;
                        try
                        {
                            _lineID = service.Create(AdvisoryEnquryLine);
                        }
                        catch (Exception ex)
                        {
                            homeadvresults.statusCode = "403";
                            homeadvresults.statusDiscription = "D365 Internal Error while creating advisory enqury line. " + ex.Message;
                            return homeadvresults;
                        }
                        if (reqParm.advisoryenquryline[i].Attachments != null)
                        {
                            for (int j = 0; j < reqParm.advisoryenquryline[i].Attachments.Count; j++)
                            {
                                ...
                                try
                                {
                                    int _doctypee = getOptionSetValue(reqParm.advisoryenquryline[i].Attachments[j].DocumentType, "hil_attachment", "hil_doctype", service);

                                    String fileName = _lineID.ToString().Replace("{", "").Replace("}", "").ToUpper() + "_" + reqParm.advisoryenquryline[i].Attachments[j].DocumentType + "_" + DateTime.Now.ToString("yyyyMMddHHmmssffff"); ;
                                    byte[] fileContent = Convert.FromBase64String(reqParm.advisoryenquryline[i].Attachments[j].FileString);
                                    blobURL = Upload(fileName, fileContent, "homeadvisory");
                                    Entity _attachment = new Entity("hil_attachment");
                                    _attachment["subject"] = reqParm.advisoryenquryline[i].Attachments[j].Subject;

                                    query = new QueryExpression("hil_attachmentdocumenttype");
                                    query.ColumnSet = new ColumnSet(false);
                                    query.Criteria = new FilterExpression(LogicalOperator.And);
                                    query.Criteria.AddCondition("statecode", ConditionOperator.Equal, 0);//Active
                                    query.Criteria.AddCondition("hil_name", ConditionOperator.Equal, reqParm.advisoryenquryline[i].Attachments[j].DocumentType.Trim());
                                    entCol = service.RetrieveMultiple(query);
                                    if (entCol.Entities.Count > 0)
                                    {
                                        _attachment["hil_documenttype"] = new EntityReference(entCol.Entities[0].LogicalName, entCol.Entities[0].Id);
                                    }
                                    _attachment["hil_doctype"] = new OptionSetValue(_doctypee);
                                    _attachment["hil_docurl"] = blobURL;
                                    _attachment["hil_docsize"] = double.Parse(reqParm.advisoryenquryline[i].Attachments[j].FileSize);
                                    _attachment["regardingobjectid"] = new EntityReference(AdvisoryEnquryLine.LogicalName, _lineID);
                                    service.Create(_attachment);
                                }
                                catch (Exception ex)
                                {
                                    homeadvresults.statusCode = "403";
                                    homeadvresults.statusDiscription = "D365 Internal Error while uploading file. " + ex.Message;
                                    return homeadvresults;
                                }
                            }
                        }
                ...
                {
                    homeadvresults.statusCode = "500";
                    homeadvresults.statusDiscription = "D365 Internal Server Error.";
                    return homeadvresults;
                }
            }
            catch (Exception ex)
        ...
        //            //{
        //            //    homeadvresults.statusCode = "204";
        //            //    homeadvresults.statusDiscription = "City is Empty";
        //            //    return homeadvresults;
        //            //}
        ...
        //            //{
        //            //    homeadvresults.statusCode = "204";
        //            //    homeadvresults.statusDiscription = "State is Empty";
        //            //    return homeadvresults;
        //            //}
        ...
        public Response RescheduleAppointment(ReschduleAppointment req)
        {
            ...
            try
            {
                ...
                {
                    res.Message = "Advisory Enquiry Line Not Found in Dynamics";
                    res.Status = false;
                    return res;
                }
        ...
        public Response CancleAppointment(CancelAppointmentRequest req)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (AdvisoryLineColl.Entities.Count == 0)
                    {
                        resp.Message = "Advisory Enquiry Line Not Found in Dynamics";
                        resp.Status = false;
                        return resp;
                    }
                    Entity Advisoryline = AdvisoryLineColl.Entities[0];
                    if (req.IsEnquiryClosed)
                    {
                        ...
                        if (_apSt)
                        {
                            resp.Message = "Enquiry and Appointment cancled Sucessfully";
                            resp.Status = true;
                            return resp;
                        }
                        else
                        {
                            resp.Message = "Enquiry Closed Sucessfully";
                            resp.Status = true;
                            return resp;
                        }
                    }
                    else
                    {
                        ...
                        if (_apSt)
                        {
                            resp.Message = "Appointment cancled Sucessfully";
                            resp.Status = true;
                            return resp;
                        }
                        else
        ...
        //    String blobURL = string.Empty;
        //    //reqParm.Subject == null || reqParm.Subject == "" ||
        ...
        //            //if (reqParm.Department != null) {
        //            //    query = new QueryExpression("hil_enquirydepartment");
        //            //    query.ColumnSet = new ColumnSet("hil_name");
        //            //    query.Criteria = new FilterExpression(LogicalOperator.And);
        //            //    query.Criteria.AddCondition("statecode", ConditionOperator.Equal, 0);
        //            //    query.Criteria.AddCondition("hil_name", ConditionOperator.Equal, reqParm.Department.Trim());
        //            //    entCol = service.RetrieveMultiple(query);
        //            //    if (entCol.Entities.Count > 0) {
        //            //        _erDepartment = entCol.Entities[0].ToEntityReference();
        //            //    }
        //            //}
        //            query = new QueryExpression("hil_attachmentdocumenttype");
        ...
        //                _rowCount = entColFile.Entities.Count + 1;

        //                _attachment["subject"] = "HIL_" + _rowCount.ToString().PadLeft(8 - _rowCount.ToString().Length,'0');
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        Guid loginUserGuid = ((WhoAmIResponse)service.Execute(new WhoAmIRequest())).UserId;
                        query = new QueryExpression("hil_attachmentdocumenttype");
                        query.ColumnSet = new ColumnSet("hil_containername", "hil_department", "hil_isidpenable");
                        query.Criteria = new FilterExpression(LogicalOperator.And);
                        query.Criteria.AddCondition("statecode", ConditionOperator.Equal, 0);
                        query.Criteria.AddCondition("hil_name", ConditionOperator.Equal, reqParm.DocumentType.Trim());
                        ...
                        {
                            //IsIDPEnable = entCol[0].Contains("hil_isidpenable") ? entCol[0].GetAttributeValue<bool>("hil_isidpenable") : false;
                            _doctypee = new EntityReference(entCol[0].LogicalName, entCol[0].Id);
                            containerName = entCol[0].Contains("hil_containername") ? entCol[0].GetAttributeValue<string>("hil_containername") : "devanduat";
                            if (entCol.Entities[0].Contains("hil_department"))
                                _erDepartment = entCol.Entities[0].GetAttributeValue<EntityReference>("hil_department");
                        ...
                        try
                        {
                            ...
                            Guid attGuid = service.Create(_attachment);
                            if (reqParm.RegardingGuid != null && reqParm.RegardingGuid != string.Empty)
                            {
                                try
                                {
                                    ...
                                    if (_entityReg.Contains("ownerid"))
                                    {
                                        owner = _entityReg.GetAttributeValue<EntityReference>("ownerid");
                                        if (loginUserGuid != owner.Id)
                                        {
                                            Assign(owner, new EntityReference(reqParm.ObjectType, new Guid(reqParm.RegardingGuid)), service);
                                        }
                            ...
                            //if (IsIDPEnable && reqParm.ObjectType == "hil_tender")
                            //{
                            //    string EmailId = "";
                            //    Entity entUser = service.Retrieve("systemuser", owner.Id, new ColumnSet("internalemailaddress", "hil_employeecode"));
                            //    string EmployeeCode = entUser.Contains("hil_employeecode") ? entUser.GetAttributeValue<string>("hil_employeecode") : null;
                            //    EmailId = entUser.Contains("internalemailaddress") ? entUser.GetAttributeValue<string>("internalemailaddress") : null;
                            //    EmailId = EmployeeCode == null ? EmailId : EmployeeCode;
                            //    if (EmailId == null)
                            //    {
                            //        resParm.Message = "EmailId Not Found.";
                            //        resParm.Status = false;
                            //        return resParm;
                            //    }
                            ...
                            //    {
                            //        n_CreatedBy = EmailId,
                            //        n_GUID = attGuid.ToString(),
                            //        s_DocumentActualName = fileName,
                            //        s_DocumentName = reqParm.Subject
                            //    }, service);
                            //    if (result.status)
                            //    {
                            //        Entity attentity = new Entity("hil_attachment", attGuid);
                            //        attentity["hil_idpprocesssteps"] = new OptionSetValue(1);// Initiated
                            //        service.Update(attentity);
                            //    }
                            //    else
                            //    {
                            //        Entity attentity = new Entity("hil_attachment", attGuid);
                            //        attentity["hil_idpprocesssteps"] = new OptionSetValue(2);// Error
                            //        service.Update(attentity);
                            //    }
                            //}
                        }
                        ...
                        resParm.Message = "File Uploaded Sucessfully";
                        resParm.Status = true;
                        return resParm;
                    }
                    catch (Exception ex)
            ...
            try
            {
                ...
                if (_entitys.Entities.Count == 1)
                {
                    if (_entitys.Entities[0].Contains("hil_appointmentid"))
                    {
                        ...
                        var client = new RestClient("https://middlewaredev.havells.com:50001/RESTAdapter/HomeAdvisory/Event/CancelEvent");
                        client.Timeout = -1;
        ...
        CreateUserMeetingResponse CreateMeeting(String AppointmentID, String SlotEnd, String SlotStart, String EnquirerEmailId, String EnquirerName, String SlotDate, String UserCode, bool IsVideo, string EnquiryID, string EnquiryType, string AdvisoryType)
        {
            ...
            //string username = "D365_HAVELLS";
            //string password = "DEVD365@1234";
            try
            {
                Slot slot = new Slot();
                ...
                var client = new RestClient("https://middlewaredev.havells.com:50001/RESTAdapter/HomeAdvisory/Event/CreateUserMeeting");
                client.Timeout = -1;
                var request = new RestRequest(Method.POST);
        ...
        public void Assign(EntityReference _Assignee, EntityReference _Targetd, IOrganizationService service)
        {
            ...
            {
                // throw new Exception("Havells_Plugin.Helper.Assign" + ex.Message);
            }
        }
