...
{
    [DataContract]
    public class UploadBulkJob_RPA
    {
        public BulkJobsModel CreateBulkJobs(BulkJobsModel BulkJobsData)
        {
            BulkJobsModel objBulkJobsModel = null;
            ...
            try
            {
                ...
                if (service != null)
                {
                    ...
                    string hil_addressline1 = BulkJobsData.AddressLine1;
                    string hil_addressline2 = BulkJobsData.AddressLine2;
                    string hil_alternatenumber = BulkJobsData.AlternateNumber;
                    string hil_area = BulkJobsData.Area;
                    Task<List<OptionSetDTO>> callerTypeOptionSet = GetOptionSetData(service, "hil_bulkjobsuploader", "hil_callertype", BulkJobsData.CallerType);
                    int callerTypeValue = Convert.ToInt32(callerTypeOptionSet.Result[0].Value);
                    OptionSetValue hil_callertype = new OptionSetValue(callerTypeValue);
                    string hil_callsubtype = BulkJobsData.CallSubType;
                    string hil_customerfirstname = BulkJobsData.CustomerFirstName;
                    string hil_customerlastname = BulkJobsData.CustomerLastName;
                    string hil_customermobileno = BulkJobsData.CustomerMobileNo;
                    string hil_dealercode = BulkJobsData.DealerNameOrCode;
                    string hil_expecteddeliverydate = BulkJobsData.ExpectedDeliveryDate;
                    string hil_landmark = BulkJobsData.Landmark;
                    string hil_natureofcomplaint = BulkJobsData.NatureofComplaint;
                    string hil_pincode = BulkJobsData.PinCode;
                    string hil_productsubcategory = BulkJobsData.ProductSubCategory;
                    string hil_salutation = BulkJobsData.Salutation;
                    #endregion
                    ...
                    {
                        if (hil_expecteddeliverydate == null) { hil_expecteddeliverydate = DateTime.Now.ToString("yyyy-mm-dd"); }
                    }
                    #endregion
                    ...
                    if (inputsValidated)
                    {
                        ...
                        entTemp = ExecuteScalar(service, "hil_consumercategory", "hil_name", "End User", new string[] { "hil_consumercategoryid" }, ref ErrorMsg);
                        if (ErrorMsg != "")
                        {
                            objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = ErrorMsg };
                            return objBulkJobsModel;
                        }
                        if (entTemp != null)
                        { erConsumerCategory = entTemp.ToEntityReference(); }
                        entTemp = ExecuteScalar(service, "hil_consumertype", "hil_name", "B2C", new string[] { "hil_consumertypeid" }, ref ErrorMsg);
                        if (ErrorMsg != "")
                        {
                            objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = ErrorMsg };
                            return objBulkJobsModel;
                        ...
                        if (entCol.Entities.Count == 1)
                        {
                            ...
                            entTemp = ExecuteScalar(service, "hil_stagingdivisonmaterialgroupmapping", "hil_name", hil_productsubcategory, new string[] { "hil_productcategorydivision", "hil_productsubcategorymg" }, ref ErrorMsg);
                            if (ErrorMsg != "")
                            {
                                objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = ErrorMsg };
                                return objBulkJobsModel;
                        ...
                        else
                        {
                            ...
                            {
                                objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = "Error While Creating Customer!!! " };
                                return objBulkJobsModel;
                            }
                        }
                        if (!_duplicateWO)
                        {
                            if (_customerGuid != Guid.Empty)
                            {
                                ...
                                Entity entPincode = ExecuteScalar(service, "hil_pincode", "hil_name", hil_pincode, new string[] { "hil_pincodeid" }, ref ErrorMsg);
                                if (ErrorMsg != "")
                                {
                                    objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = ErrorMsg };
                                    return objBulkJobsModel;
                                ...
                                Tuple<EntityReference, string> tplCustomerAddress = GetCustomerAddress(service, _customerGuid, erPinCode != null ? erPinCode.Id : Guid.Empty);
                                if (tplCustomerAddress.Item2 != "")
                                {
                                    objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = tplCustomerAddress.Item2 };
                                    return objBulkJobsModel;
                                }
                                else
                                {
                                    erAddress = tplCustomerAddress.Item1;
                                }
                                if (erAddress == null)
                                {
                                    entTemp = ExecuteScalar(service, "hil_area", "hil_name", hil_area, new string[] { "hil_areaid" }, ref ErrorMsg);
                                    if (ErrorMsg != "")
                                    {
                                        objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = ErrorMsg };
                                        return objBulkJobsModel;
                                    ...
                                    if (entPincode != null)
                                    {
                                        ...
                                        if (entCol.Entities.Count >= 1)
                                        {
                                            ...
                                            {
                                                objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = "Error While Creating Consumer's Address." };
                                                return objBulkJobsModel;
                                            }
                                        }
                                        else
                                        {
                                            objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = "No Business Geo Mapping found for PIN Code." };
                                            return objBulkJobsModel;
                                        }
                                    }
                                    else
                                    {
                                        objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = "PIN Code does not exist." };
                                        return objBulkJobsModel;
                                    }
                                }
                            }
                            ...
                            if (erAddress == null)
                            {
                                entTemp = ExecuteScalar(service, "hil_pincode", "hil_name", hil_pincode, new string[] { "hil_pincodeid" }, ref ErrorMsg);
                                if (ErrorMsg != "")
                                {
                                    objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = ErrorMsg };
                                    return objBulkJobsModel;
                            ...
                            if (entConsumer != null && erAddress != null)
                            {
                                ...
                                if (entTemp != null)
                                {
                                    ...
                                    erNatureOfComplaint = GetNatureOfComplaint(service, hil_natureofcomplaint, entTemp.GetAttributeValue<EntityReference>("hil_productsubcategorymg").Id, ref ErrorMsg);
                                    if (ErrorMsg != "")
                                    {
                                        objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = ErrorMsg };
                                        return objBulkJobsModel;
                                    ...
                                    entTemp = ExecuteScalar(service, "hil_callsubtype", "hil_name", hil_callsubtype, new string[] { "hil_callsubtypeid" }, ref ErrorMsg);
                                    if (ErrorMsg != "")
                                    {
                                        objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = ErrorMsg };
                                        return objBulkJobsModel;
                                    ...
                                    {
                                        enPMSWorkorder["hil_expecteddeliverydate"] = Convert.ToDateTime(hil_expecteddeliverydate);
                                    }
                                    ...
                                    string JobNo = "";
                                    if (jobId != Guid.Empty)
                                        JobNo = service.Retrieve("msdyn_workorder", jobId, new ColumnSet("msdyn_name")).GetAttributeValue<string>("msdyn_name");
                                    objBulkJobsModel = new BulkJobsModel { StatusCode = "200", StatusDescription = "Job created successfully.", JobID = Convert.ToString(jobId), JobNo = JobNo };
                                    return objBulkJobsModel;
                                }
                                else
                                {
                                    objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = "Product Sub Category Configuration (MG4) is missing." };
                                    return objBulkJobsModel;
                                }
                            }
                            else
                            {
                                if (entConsumer == null)
                                {
                                    objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = "Customer does not exist." };
                                    return objBulkJobsModel;
                                }
                                else if (erAddress == null)
                                {
                                    objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = "Customer Address does not exist. " };
                                    return objBulkJobsModel;
                                }
                            }
                        }
                        ...
                        {
                            objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = "Duplicate Job. Old Job# " + _duplicateWOIds };
                            return objBulkJobsModel;
                        }
                    }
                    else
                    {
                        objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = strInputsValidationsummary };
                        return objBulkJobsModel;
                    }
                    #endregion
                }
                ...
                {
                    objBulkJobsModel = new BulkJobsModel { StatusCode = "204", StatusDescription = "D365 Service Unavailable" };
                    return objBulkJobsModel;
                }
            }
            catch (Exception ex)
            {
                objBulkJobsModel = new BulkJobsModel { StatusCode = "500", StatusDescription = "D365 Internal Server Error : " + ex.Message.ToUpper() };
                return objBulkJobsModel;
            }
            return objBulkJobsModel;
        }
        private async Task<List<OptionSetDTO>> GetOptionSetData(IOrganizationService service, string entityName, string propertyName, string optionSetlabel)
        {
        ...
        public Tuple<EntityReference, string> GetCustomerAddress(IOrganizationService service, Guid customerGuid, Guid _pincode)
        {
            ...
            {
                return Tuple.Create(retValue, ex.Message);
            }
            return Tuple.Create(retValue, "");
        }
        public EntityReference GetNatureOfComplaint(IOrganizationService service, string noc, Guid relatedProduct, ref string ErrorMsg)
        {
            EntityReference retValue = null;
            QueryExpression Query;
            EntityCollection enCol;
        ...
        public Entity ExecuteScalar(IOrganizationService service, string entityName, string primaryField, string primaryFieldValue, string[] columns, ref string ErrorMsg)
        {
        ...
        public bool GetCallSubTypeByNOC(IOrganizationService service, Guid callSubTypeGuid, Guid nocGuid)
        {
            bool retValue = false;
            QueryExpression Query;
            EntityCollection enCol;
    ...
    [DataContract]
    public class BulkJobsModel
    {
        [DataMember]
        public Guid hil_addressline1 { get; set; }
