...
namespace ConsumerAppServices
{
    ...
    public interface IConsumerAppWS
    {
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/IoTRegisteredProductsProd",
                   Method = "POST", RequestFormat = WebMessageFormat.Json,
                   ResponseFormat = WebMessageFormat.Json)]
        List<IoTRegisteredProducts> GetIoTRegisteredProductsProd(IoTRegisteredProducts registeredProducts);
       ...
       ResponseFormat = WebMessageFormat.Json)]
        ...
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        List<ProductDTO> GetProducts(IoTCommonLib ProductSubCatgInfo);
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/IoTNatureOfComplaint",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        List<IoTNatureofComplaint> GetIoTNatureOfComplaints(IoTNatureofComplaint natureOfComplaint);
        ...
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        IoTRegisteredProductsResult RegisterProduct(IoTRegisteredProducts productData);
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/AuthenticateKKGCode",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        ValidateKKGCodeResult ValidateKKGCode(KKGCodeValidator jobData);

        [OperationContract]
        [WebInvoke(UriTemplate = "/FlushUATData",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        FlushUATDataResult FlushData(FlushUATData flushUATData);


        [OperationContract]
        [WebInvoke(UriTemplate = "/UserManagement",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        UserManagement UpdateBusinessUnit(UserManagement userBUData);
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/ValidateSerialNumberDev",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        ValidateSerialNumberDEV GetResponseFromSAPDEV(ValidateSerialNumberDEV iValidate);
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/AMGetDocumentTypes",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        List<DocumemtType> AMGetDocumentTypes(DocumemtType docType);
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/GetConsumerSurvey",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        ConsumerSurveyDTO GetConsumerSurvey(ConsumerSurveyDTO _consumerSurveyData);


        [OperationContract]
        [WebInvoke(UriTemplate = "/UpdateConsumerSurvey",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        ConsumerSurveyDTO CaptureConsumerSurvey(ConsumerSurveyDTO _consumerSurveyData);
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/GetAccessToken",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/GetMakes",
        Method = "GET", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        List<Makes> GetMakes();
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/CreateServiceCallVoiceBotUAT",
           Method = "POST", RequestFormat = WebMessageFormat.Json,
           ResponseFormat = WebMessageFormat.Json)]
        IoTServiceCallRegistration IoTCreateServiceVoiceBotUAT(IoTServiceCallRegistration serviceCalldata);

        #endregion
        #region
        [OperationContract]
        [WebInvoke(UriTemplate = "/GetPerformaInvoiceAnnexure",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        AnnextureResponse GenerateAnnexureUrl(string _PerformaInvoice);
        #endregion
        [OperationContract]
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/CreateSession",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        ValidateSessionResponse CreateSession(AuthenticateConsumer requestParam);

        [OperationContract]
        [WebInvoke(UriTemplate = "/AuthenticateSamparkAppLogin",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        AuthModel AuthenticateSamparkAppLogin(AuthModel request_param);

        #region MFR Service Job
        [OperationContract]
        [WebInvoke(UriTemplate = "/CreateServiceRequest",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        JobRequestDTO CreateServiceCallRequest(JobRequestDTO _jobRequest);

        [OperationContract]
        [WebInvoke(UriTemplate = "/GetServiceRequestStatus",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        JobStatusDTO GetJobstatus(JobStatusDTO _jobRequest);

        [OperationContract]
        [WebInvoke(UriTemplate = "/GetServiceRequestStatusByDealerCode",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        WorkOrderResponse GetWorkOrdersStatus(WorkOrderRequest objreq); 

        #endregion
        [OperationContract] 
        [WebInvoke(UriTemplate = "/GetGlobalSearchEntities",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        GlobalSearchResponse GetGlobalSearch(GlobalSearchRequest req);
        ...
        #region IDP Process
        [OperationContract]
        [WebInvoke(UriTemplate = "/UpdateIDPProcess",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        IDPProcessResponse UpdateIDPProcess(IDPProcessDetails _data);
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "/GetEcom_Priceinfo",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        Ecom_PriceDetailsResponse GetEcom_Priceinfo(Ecom_PriceDetailsRequest _data);

        #endregion

        [OperationContract]
        [WebInvoke(UriTemplate = "/CreateBulkJobs",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        BulkJobsModel CreateBulkJobs(BulkJobsModel BulkJobsData);

        #region LitmusCustomerFeedBack

        [OperationContract]
        [WebInvoke(UriTemplate = "/UpdateCustomerFeedBack",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        LtimusFeedBackResponse UpdateLitmusCustomerFeedBack(LtimusCustomerFeedBack ParamCustFeedBack);

        #endregion
        #region Whatsapp Campain
        [OperationContract]
        [WebInvoke(UriTemplate = "/UpdateKKGConsentOnJob",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        KKGResponse UpdateKKGConsentOnJob(KKGRequest kKGRequest);

        #endregion
        #region Loyalty Program
        [OperationContract]
        [WebInvoke(UriTemplate = "/SendEnrollmentLink",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
        sendEnrollmentRes SendEnrollmentLink(sendEnrollmentReq sendEnrollmentReq);
		...
		#region Ala carte
		[OperationContract]
		[WebInvoke(UriTemplate = "/CreateSalesOrderAndOrderline",
        Method = "POST", RequestFormat = WebMessageFormat.Json,
        ResponseFormat = WebMessageFormat.Json)]
		OrderCreateresponse CreateSalesOrder(CreateSalesOrderModel createSalesOrderModel);
		#endregion
