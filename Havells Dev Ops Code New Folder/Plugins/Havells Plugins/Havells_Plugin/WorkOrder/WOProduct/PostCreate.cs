    ...
    public class PostCreate: IPlugin
    {
       ...
       static ITracingService tracingService =null;
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            {
                throw new Exception("Havells_Plugin.WorkOrderProduct.PostCreate.WorkOrderProductConfig" + ex.Message);
            }
            #endregion
        }
            ...
            if(WrkPdt.msdyn_Product != null && WrkPdt.msdyn_CustomerAsset != null && WrkPdt.msdyn_WorkOrderIncident != null)
            {
                ...
                if(Warranty.Value != 2)
                {
                    ...
                    if (_enAssetWty.Attributes.Contains("hil_warrantytilldate"))
                    {
                        ...
                        {
                            iUpdateWrkPdt.hil_WarrantyStatus = new OptionSetValue(1);
                        ...
                        else
                        {
                            ...
                            if (Found.Entities.Count > 0)
                            {
                                foreach (hil_unitwarranty UnitWrty in Found.Entities)
                                {
                                    ...
                                    {
                                        //Tracing.Trace("12");
                                        iUpdateWrkPdt.hil_WarrantyStatus = new OptionSetValue(2);
