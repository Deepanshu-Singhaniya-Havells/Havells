...
{
    public class CaseAssignmentMatrixPreCreate : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity
                  && context.PrimaryEntityName.ToLower() == "hil_caseassignmentmatrix" && context.Depth == 1)
                {
                    ...
                    entity["hil_name"] = "CAM-" + _rowCount.ToString().PadLeft(5, '0');
                }
            }
            catch (Exception ex)
            {
