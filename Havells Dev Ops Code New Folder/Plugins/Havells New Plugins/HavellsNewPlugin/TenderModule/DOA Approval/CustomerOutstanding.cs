    ...
    public class CustomerOutstanding : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                ...
                IRestResponse resposeCreditCheck = Integration(intConfigCreditCheck, dataCreditCheck);
               // throw new InvalidPluginExecutionException("resposeCreditCheck " + resposeCreditCheck.Content);
                ...
                IRestResponse resposeGetOpenItems = Integration(intConfigGetOpenItems, dataGetOpenItems);
        ...
        public IRestResponse Integration(IntegrationConfig intConfig, string data)
        {
