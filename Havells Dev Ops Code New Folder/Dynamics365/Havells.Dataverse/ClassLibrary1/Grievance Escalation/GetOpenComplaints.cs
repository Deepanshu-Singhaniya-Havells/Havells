...
{
    public class GetOpenComplaints : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                ...
                var _response = GetOpenComplaint(service, CustomerGuid);
        ...
        public (OpenComplaints_Response, RequestStatus) GetOpenComplaint(IOrganizationService _CrmService, string CustomerGuid)
        {
