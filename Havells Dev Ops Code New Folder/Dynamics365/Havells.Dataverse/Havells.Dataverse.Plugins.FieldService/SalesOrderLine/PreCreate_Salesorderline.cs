		...
		public void Execute(IServiceProvider serviceProvider)
		{
			...
			try
			{
				if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity && context.PrimaryEntityName.ToLower() == "salesorderdetail")
				{
					...
					{
						if ((orderconct.GetAttributeValue<OptionSetValue>("hil_source").Value == 3) 
							&& (orderconct.GetAttributeValue<EntityReference>("hil_ordertype").Id.ToString() == "1f9e3353-0769-ef11-a670-0022486e4abb" 
							|| orderconct.GetAttributeValue<EntityReference>("hil_ordertype").Id.ToString() == "b8a83059-0769-ef11-a670-0022486e4abb"))
						{
			...
			{
				throw new InvalidPluginExecutionException("HavellsNewPlugin.SalesOrder.SalesOrderlinePreCreate.Execute Error :  " + ex.Message); //HavellsNewPlugin.SalesOrderlinePreCreate.Execute Error
			}
		}
	}
}
